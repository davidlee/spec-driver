...
- @app.command(issue) `show_issue(issue_id, json_output, path_only, raw_output, content_type, root) -> None`: Show detailed information about an issue.
...
- @app.command(requirement) `show_requirement(req_id, json_output, path_only, raw_output, content_type, root) -> None`: Show detailed information about a requirement.
...
- @app.command(spec) `show_spec(spec_id, json_output, path_only, raw_output, content_type, root) -> None`: Show detailed information about a specification.
