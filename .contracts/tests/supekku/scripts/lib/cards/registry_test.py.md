...
- `test_auto_creates_template_if_missing(self) -> None`: Auto-creates kanban/template.md from the packaged template asset.
...
### TestCardRegistryStandardSurface
