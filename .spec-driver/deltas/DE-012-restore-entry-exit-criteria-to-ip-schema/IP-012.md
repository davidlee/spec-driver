...
phases:
  - id: IP-012.PHASE-01
    ...
    objective:
      Restore entry/exit criteria fields to plan.overview schema and update
...
_Single-phase implementation: schema changes + phase creation enhancement are tightly coupled and can be implemented together._
