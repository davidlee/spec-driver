...
aliases: []
applies_to:
  specs: [SPEC-113, SPEC-110, PROD-010]
  requirements: [ISSUE-025]
---
...
- **Risk**: Breaking existing automation scripts – _Likelihood_: low – _Impact_: low – _Mitigation_: Backward compatible, scripts just see fewer (still valid) items
- **Risk**: Users confused by "missing" items – _Likelihood_: medium – _Impact_: low – _Mitigation_: Clear help text, informative footer messages
