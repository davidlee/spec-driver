...
name: Design Revision - Add default filtering and pagination to backlog list command
created: '2025-11-08'
updated: '2025-11-08'
status: draft
...
# DR-020 – Add default filtering and pagination to backlog list command

## 1. Executive Summary
- **Delta**: [DE-020](./DE-020.md)
