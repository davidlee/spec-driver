...
- **Risk**: Subprocess spawning complexity – _Likelihood_: low – _Impact_: low – _Mitigation_: Use `subprocess.run()` with simple interface
- **Risk**: Platform differences (Windows) – _Likelihood_: medium – _Impact_: low – _Mitigation_: Document requirements; test on Linux/macOS
