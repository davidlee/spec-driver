...
- Encodes _some_ meaning (at least type/domain), without becoming a brittle taxonomy
...
1. How to identify the _artifact kind_ (ADR vs SPEC vs MEM vs others) in an inline `[[...]]`
2. How to identify memory _type_ (skill/system/workset/etc.)
...
### How to derive memory _type_ if IDs aren’t trusted
