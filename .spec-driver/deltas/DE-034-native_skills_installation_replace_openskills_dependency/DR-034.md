...
name: 'Design Revision - Native skills installation: replace openskills dependency'
created: '2026-03-03'
updated: '2026-03-03'
status: draft
...
# DR-034 – Native skills installation: replace openskills dependency

## 1. Executive Summary
- **Delta**: [DE-034](./DE-034.md)
