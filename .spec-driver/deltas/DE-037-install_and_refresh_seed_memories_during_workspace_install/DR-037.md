...
name: Design Revision - install and refresh seed memories during workspace install
created: '2026-03-03'
updated: '2026-03-03'
status: draft
...
# DR-037 – install and refresh seed memories during workspace install

## 1. Executive Summary

- **Delta**: [DE-037](./DE-037.md)
