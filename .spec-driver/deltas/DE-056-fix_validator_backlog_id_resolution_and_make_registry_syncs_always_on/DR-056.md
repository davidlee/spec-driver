...
name: Design Revision - fix validator backlog ID resolution and make registry syncs always-on
created: "2026-03-07"
updated: "2026-03-07"
status: draft
...
# DR-056 – fix validator backlog ID resolution and make registry syncs always-on

## 1. Executive Summary

- **Delta**: [DE-056](./DE-056.md)
