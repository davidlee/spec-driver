...
name: "Design Revision - workflow.toml: rich commented defaults and config memory"
created: "2026-03-08"
updated: "2026-03-08"
status: draft
...
# DR-062 – workflow.toml: rich commented defaults and config memory

## 1. Executive Summary

- **Delta**: [DE-062](./DE-062.md)
