...
name: "Design Revision - Rename [cards]/[docs] config to [kanban] and always render card explanation"
created: "2026-03-09"
updated: "2026-03-09"
status: draft
...
# DR-080 – Rename [cards]/[docs] config to [kanban] and always render card explanation

## 1. Executive Summary

- **Delta**: [DE-080](./DE-080.md)
