...
name: Implementation Plan - Rename [cards]/[docs] config to [kanban] and always render card explanation
created: '2026-03-09'
updated: '2026-03-09'
status: draft
kind: plan
...
- **Research Notes**: `DE-080/notes.md` (Phase 0 output)
- **Design Revision**: `DE-080/DR-XXX.md`
