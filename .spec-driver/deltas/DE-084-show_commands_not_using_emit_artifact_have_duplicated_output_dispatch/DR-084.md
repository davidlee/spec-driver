...
name: Design Revision - Show commands not using emit_artifact have duplicated output dispatch
created: '2026-03-09'
updated: '2026-03-09'
status: draft
...
# DR-084 – Show commands not using emit_artifact have duplicated output dispatch

## 1. Executive Summary

- **Delta**: [DE-084](./DE-084.md)
