...
12. `.relations` property on DecisionRecord, PolicyRecord, StandardRecord, RequirementRecord
13. `_collect_from_backlog_fields()` collector for BacklogItem frontmatter references
