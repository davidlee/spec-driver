...
name: 'Implementation Plan - Jailed coding agent harness: pi subprocess via RPC with bubblewrap sandboxing'
created: '2026-03-14'
updated: '2026-03-14'
status: draft
kind: plan
...
- **Research Notes**: `DE-092/notes.md` (Phase 0 output)
- **Design Revision**: `DE-092/DR-XXX.md`
