...
name: 'Implementation Plan - pi extension: preboot hook for fresh governance context on startup and reload'
created: '2026-03-14'
updated: '2026-03-14'
status: draft
kind: plan
...
- **Research Notes**: `DE-093/notes.md` (Phase 0 output)
- **Design Revision**: `DE-093/DR-XXX.md`
