...
name: Implementation Plan - improve pi skill adherence for spec-driver installed skills
created: "2026-03-16"
updated: "2026-03-16"
status: draft
kind: plan
...
- **Research Notes**: `DE-098/notes.md` (Phase 0 output)
- **Design Revision**: `DE-098/DR-XXX.md`
