...
name: "Design Revision - fix: ensure u+w on files copied from read-only sources"
created: "2026-03-16"
updated: "2026-03-16"
status: draft
...
# DR-099 – fix: ensure u+w on files copied from read-only sources

## 1. Executive Summary

- **Delta**: [DE-099](./DE-099.md)
