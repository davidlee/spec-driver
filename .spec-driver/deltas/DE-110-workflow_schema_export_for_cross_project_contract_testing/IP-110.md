...
name: Implementation Plan - Workflow schema export for cross-project contract testing
created: "2026-03-22"
updated: "2026-03-22"
status: draft
kind: plan
...
- **Research Notes**: `DE-110/notes.md` (Phase 0 output)
- **Design Revision**: `DE-110/DR-XXX.md`
