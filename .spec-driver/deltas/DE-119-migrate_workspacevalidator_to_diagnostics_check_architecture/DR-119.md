...
name: Design Revision - Migrate WorkspaceValidator to diagnostics check architecture
created: "2026-03-22"
updated: "2026-03-22"
status: draft
...
# DR-119 – Migrate WorkspaceValidator to diagnostics check architecture

## 1. Executive Summary

- **Delta**: [DE-119](./DE-119.md)
