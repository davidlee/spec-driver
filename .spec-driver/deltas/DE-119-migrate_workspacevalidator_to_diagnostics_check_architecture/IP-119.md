...
name: Implementation Plan - Migrate WorkspaceValidator to diagnostics check architecture
created: "2026-03-22"
updated: "2026-03-22"
status: draft
kind: plan
...
- **Research Notes**: `DE-119/notes.md` (Phase 0 output)
- **Design Revision**: `DE-119/DR-XXX.md`
