...
name: "Design Revision - Paths and config decoupling: replace mutable globals with value objects"
created: "2026-03-22"
updated: "2026-03-22"
status: draft
...
# DR-121 – Paths and config decoupling: replace mutable globals with value objects

## 1. Executive Summary

- **Delta**: [DE-121](./DE-121.md)
