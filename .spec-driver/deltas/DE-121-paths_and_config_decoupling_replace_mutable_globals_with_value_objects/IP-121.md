...
name: "Implementation Plan - Paths and config decoupling: replace mutable globals with value objects"
created: "2026-03-22"
updated: "2026-03-22"
status: draft
kind: plan
...
- **Research Notes**: `DE-121/notes.md` (Phase 0 output)
- **Design Revision**: `DE-121/DR-XXX.md`
