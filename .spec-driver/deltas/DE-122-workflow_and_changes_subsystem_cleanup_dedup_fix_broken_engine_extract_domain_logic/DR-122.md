...
name: "Design Revision - Workflow and changes subsystem cleanup: dedup, fix broken engine, extract domain logic"
created: "2026-03-22"
updated: "2026-03-22"
status: draft
...
# DR-122 – Workflow and changes subsystem cleanup: dedup, fix broken engine, extract domain logic

## 1. Executive Summary

- **Delta**: [DE-122](./DE-122.md)
