...
name: "Implementation Plan - Workflow and changes subsystem cleanup: dedup, fix broken engine, extract domain logic"
created: "2026-03-22"
updated: "2026-03-22"
status: draft
kind: plan
...
- **Research Notes**: `DE-122/notes.md` (Phase 0 output)
- **Design Revision**: `DE-122/DR-XXX.md`
