...
1. **User**: Approve or edit this DR (status → approved when ready).
2. **External review** (optional): Paste DR §2–§7 to another reviewer for challenge.
3. **Planning**: `/plan-phases` — repair [IP-131](./IP-131.md) scaffold, add `phases/phase-01.md`, wire verification IDs to real test functions.
