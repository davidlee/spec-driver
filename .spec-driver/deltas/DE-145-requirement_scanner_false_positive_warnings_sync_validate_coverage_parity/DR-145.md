...
name: Design Revision - Requirement scanner false-positive warnings + sync/validate coverage parity
created: "2026-05-30"
updated: "2026-05-30"
status: draft
...
# DR-145 – Requirement scanner false-positive warnings + sync/validate coverage parity

## 1. Executive Summary

- **Delta**: [DE-145](./DE-145.md)
