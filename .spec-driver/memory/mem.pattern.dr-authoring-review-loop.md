...
summary: "For draft-design-revision work: keep the DR progressive, add code-adjacent examples where needed, consult doctrine, run an internal adversarial pass, reconcile DE, then optionally print an external-review prompt before planning."
scope:
  paths:
