...
summary: "Before touching a subsystem, query memories with concrete file paths so glob-scoped records surface; during phase or delta wrap-up, promote durable findings into memories."
priority:
  severity: high
  weight: 8
scope:
