...
relations:
  - type: documents
    target: DE-007
destination_specs: [PROD-008, PROD-009]
requirements:
  - PROD-008.FR-001
  - PROD-008.FR-002
  - PROD-008.FR-003
...
requirements:
  - requirement_id: PROD-008.FR-001
    ...
    action: modify
    summary:
      "The specs frontmatter and coverage block MUST be the authoritative record\
  ...
  - requirement_id: PROD-008.FR-003
    ...
    action: modify
    summary:
      Audits MUST reconcile observed behaviour against the spec coverage block
  ...
  - requirement_id: PROD-009.FR-002
    ...
    action: modify
    summary:
      The lifecycle engine MUST overlay statuses from deltas and audits using
  ...
  - requirement_id: PROD-009.FR-003
    ...
    action: modify
    summary:
      Validation MUST emit corrective warnings when overlays disagree and keep
