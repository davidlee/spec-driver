...
requirements:
  ...
  - requirement_id: PROD-003.FR-004
    ...
    action: modify
    summary:
      'System MUST support standard statuses: draft, required, default, deprecated
  ...
  - requirement_id: PROD-003.FR-005
    ...
    action: modify
    summary:
      System MUST provide CLI commands to list policies and standards with filtering
  ...
  - requirement_id: PROD-003.FR-006
    ...
    action: modify
    summary:
      System MUST provide CLI commands to display full policy/standard details
  ...
  - requirement_id: PROD-003.FR-007
    ...
    action: modify
    summary:
      System MUST support bidirectional cross-references between policies and
  ...
  - requirement_id: PROD-003.FR-008
    ...
    action: modify
    summary:
      System MUST allow ADRs, specs, deltas, and other artifacts to reference
  ...
  - requirement_id: PROD-003.NF-001
    ...
    action: modify
    summary:
      Policies and standards MUST use consistent template structure (Statement,
  ...
  - requirement_id: PROD-003.NF-002
    ...
    action: modify
    summary:
      CLI commands for policies/standards MUST follow existing spec-driver UX
