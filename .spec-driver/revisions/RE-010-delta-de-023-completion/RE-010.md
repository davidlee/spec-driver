...
requirements: [PROD-013.FR-003, PROD-013.FR-004]
---
...
requirements:
  - requirement_id: PROD-013.FR-003
    ...
    action: modify
    summary:
      "System MUST provide `view` command that opens artifact in `$PAGER` (fallback:
      less, more)"
    destination:
      spec: PROD-013
      requirement_id: PROD-013.FR-003
  ...
  - requirement_id: PROD-013.FR-004
    ...
    action: modify
    summary:
      "System MUST provide `edit` command that opens artifact in `$EDITOR` (fallback:
      $VISUAL, vi)"
    destination:
      spec: PROD-013
      requirement_id: PROD-013.FR-004
