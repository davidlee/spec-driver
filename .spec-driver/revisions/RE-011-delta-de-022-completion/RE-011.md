...
- type: documents
  target: DE-022
destination_specs: [PROD-013]
requirements: [PROD-013.FR-001, PROD-013.FR-006, PROD-013.FR-007]
---
...
requirements:
  - requirement_id: PROD-013.FR-001
    ...
    action: modify
    summary:
      All `show` subcommands MUST support `--path` flag that outputs only the
      file path
    destination:
      spec: PROD-013
      requirement_id: PROD-013.FR-001
