...
- requirement_id: PROD-016.FR-001
  kind: functional
  action: modify
  summary: The repository MUST have a single workflow configuration file (TOML) readable
...
- requirement_id: PROD-016.FR-006
  kind: functional
  action: modify
  summary: The system MUST generate a short prescriptive project agent bootstrap (~30
...
- requirement_id: PROD-016.FR-008
  kind: functional
  action: modify
  summary: 'The system MUST generate project-local, config-tailored guidance markdown
