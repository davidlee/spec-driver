...
- requirement_id: SPEC-110.FR-002
  kind: functional
  action: modify
  summary: List commands MUST delegate all data access to registries and all formatting
...
- requirement_id: SPEC-110.FR-005
  kind: functional
  action: modify
  summary: 'All list commands MUST support consistent flag patterns (--format, --json,
...
- requirement_id: SPEC-110.FR-006
  kind: functional
  action: modify
  summary: 'All list commands MUST support output formats: table (default), json,
