---
name: next
description: Print a concise continuation prompt for the next agent. Use this when everything is written down and in order
  for the next agent, and the user has indicated they wish to continue with fresh context.
---
