...
c4_level: code
responsibilities:
  - Define the skill subsystem boundary between packaged skill sources, installed skill copies, and the supporting sync/install library.
  - Keep routing and execution guidance procedural in packaged skills rather than duplicating it across generated docs or ad hoc prose.
