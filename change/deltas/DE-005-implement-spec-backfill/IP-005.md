...
phases:
  - id: IP-005.PHASE-01
    ...
    objective: >-
      Implement single-spec backfill: template retrieval, stub detection,
...
entries:
  - artefact: VT-004
    ...
    status: planned
    notes: Stub detection correctly identifies stub vs modified specs
  - artefact: VT-005
    kind: VT
    requirement: PROD-007.FR-006
    phase: IP-005.PHASE-01
    status: planned
    notes: Template retrieval working for both product and tech specs
  - artefact: VT-001
    kind: VT
    requirement: PROD-007.FR-001
    phase: IP-005.PHASE-01
    status: planned
    notes: End-to-end single spec backfill workflow functional
```
...
- [ ] Phase 01 in progress (see `phases/phase-01.md` for detailed task status)
- [ ] Phase 01 complete
