...
entries:
  - artefact: VT-PROD010-BACKLOG-001
    ...
    status: planned
    notes: Test backlog shortcuts with filters (list issues/problems/improvements/risks)
```

## 1. Summary
- **Delta**: DE-014 - Backlog command shortcuts
- **Specs Impacted**: PROD-002 (FR-011)
...
## 3. Gate Check
- [x] Backlog items linked and prioritised (FR-011 from requirements-additions-2025-11-04.md)
- [x] Spec(s) updated or delta specifies required changes (PROD-002 FR-011 documented)
