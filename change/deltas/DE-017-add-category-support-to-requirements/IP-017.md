...
entries:
  - artefact: VT-017-001
    ...
    status: planned
    notes: Unit tests for category parsing (inline + frontmatter)
  - artefact: VT-017-002
    kind: VT
    phase: IP-017.PHASE-01
    status: planned
    notes: Unit tests for merge precedence (body > frontmatter)
  - artefact: VT-017-003
    kind: VT
    phase: IP-017.PHASE-02
    status: planned
    notes: Integration tests for CLI category filtering
  - artefact: VT-017-004
    kind: VT
    phase: IP-017.PHASE-02
    status: planned
    notes: Integration tests for category column display
  - artefact: VH-017-001
    kind: VH
    phase: IP-017.PHASE-03
    status: planned
    notes: Manual verification of category workflow in real specs
```
...
- [ ] Phase 3 complete (Verification & Polish)
- [ ] All verification artifacts complete (VT-017-001 through VH-017-001)
