...
entries:
  ...
  - artefact: VT-019-003
    ...
    status: planned
    notes: Integration test for sync with missing ts-doc-extract (Phase 3)
  - artefact: VT-019-004
    kind: VT
...
- [x] All unit tests passing (59/59: 32 npm_utils + 27 TypeScriptAdapter)
- [ ] All integration tests passing (VT-019-003 in Phase 3)
- [x] Lint passing (ruff + pylint: 9.71/10, 10.00/10)
- [ ] Manual verification complete (deferred to Phase 3)
