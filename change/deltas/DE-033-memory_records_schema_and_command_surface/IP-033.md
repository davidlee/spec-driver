...
- **Research Notes**: `DE-033/notes.md` (Phase 0 output)
- **Design Revision**: `DE-033/DR-033.md`
...
- **External Skills Gate**: Track required memory skills publication in `spec-driver-skills` as a v1 release-readiness check.
