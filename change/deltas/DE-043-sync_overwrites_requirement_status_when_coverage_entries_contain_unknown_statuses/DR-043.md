...
name: Design Revision - sync overwrites requirement status when coverage entries contain
  unknown statuses
created: '2026-03-05'
updated: '2026-03-05'
status: draft
...
# DR-043 – sync overwrites requirement status when coverage entries contain unknown statuses
