...
name: Design Revision - migrate spec auto-creation opt-in from marker file to workflow.toml
created: '2026-03-06'
updated: '2026-03-06'
status: draft
...
# DR-051 – migrate spec auto-creation opt-in from marker file to workflow.toml

## 1. Executive Summary
- **Delta**: [DE-051](./DE-051.md)
