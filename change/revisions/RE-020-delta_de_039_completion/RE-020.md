...
- requirement_id: PROD-016.FR-002
  kind: functional
  action: modify
  summary: 'The configuration MUST cover the majority of workflow shaping needs with
...
- requirement_id: PROD-016.FR-009
  kind: functional
  action: modify
  summary: 'Workflow completion commands MUST be automation-safe in non-interactive
    contexts:'
  destination:
    spec: PROD-016
    requirement_id: PROD-016.FR-009
...
- requirement_id: PROD-016.FR-010
  kind: functional
  action: modify
  summary: The CLI MUST provide first-class create/complete command coverage for active
