...
- **Unit specs** may *summarize* and *reference* observed contracts, but MUST NOT attempt to be the authoritative
  source of signatures/types/schemas when those are generated from code.
- **Assembly specs** may specify *requirements and constraints* on interfaces (compatibility, invariants, expected
