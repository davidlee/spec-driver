# supekku.scripts.lib.blocks.plan_metadata
...
- `PHASE_OVERVIEW_METADATA` - Metadata definition for phase overview blocks
- `PLAN_OVERVIEW_METADATA` - Metadata definition for plan overview blocks
- `__all__`
