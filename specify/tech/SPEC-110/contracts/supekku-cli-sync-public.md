...
- @app.command `sync(targets, language, existing, check, dry_run, allow_missing_source, specs, adr, prune, force) -> None`: Synchronize specifications and registries with source code.
