...
- `KNOWN_LEAF_PACKAGES` - Known leaf packages in supekku/ (as of 2026-02-20)
...
- `test_finds_all_20_leaf_packages_in_supekku(self) -> None`: Test that all 20 known leaf packages are discovered.
