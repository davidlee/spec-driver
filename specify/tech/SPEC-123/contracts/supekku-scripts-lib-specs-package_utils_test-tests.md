...
- `KNOWN_LEAF_PACKAGES` - Known leaf packages in supekku/ (as of 2026-02-03)
...
- `test_finds_all_19_leaf_packages_in_supekku(self) -> None`: Test that all 19 known leaf packages are discovered.
