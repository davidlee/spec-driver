...
class BacklogLibraryTest(unittest.TestCase):
    ...
    def test_create_backlog_entry_writes_frontmatter(self) -> None:
        ...
        self.assertIn("id: ISSUE-001", text)
        self.assertIn("name: Investigate feature flag", text)
    ...
    def test_append_backlog_summary_appends_missing_entries(self) -> None:
        ...
        self.assertIn("ISSUE-001", summary)
        self.assertIn(entry.relative_to(root / "backlog").as_posix(), summary)
