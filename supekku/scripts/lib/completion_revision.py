"""Utilities for creating completion revisions documenting delta lifecycle transitions."""
...
def create_completion_revision(
    ...
    *,
    ...
    Args:
        ...
        revision_name: Optional custom revision name (defaults to "Delta {delta_id} completion")
