...
class TestGoAdapter(unittest.TestCase):
    ...
    def test_supports_identifier_valid_go_packages(self) -> None:
        ...
        for identifier in valid_identifiers:
            with self.subTest(identifier=identifier):
                assert self.adapter.supports_identifier(identifier), f"Should support Go package: {identifier}"
    ...
    def test_describe_go_package(self) -> None:
        ...
        assert descriptor.default_frontmatter["packages"] == ["internal/application/pipeline"]
    ...
    @patch("pathlib.Path.exists")
    @patch("pathlib.Path.mkdir")
    def test_generate_check_mode(self, _mock_mkdir, mock_exists, mock_subprocess) -> None:
